       ...
       /* $http.get('environment.properties').then(function (response) {
		...
		.success(function(data){
			...
			if(data.success==1){
			  ...
			  console.log("data.accounts = : "+JSON.stringify(data.accounts));
			  $window.localStorage.setItem('userAccounts', JSON.stringify(data.accounts));
			  $window.localStorage.setItem('currentAccount', JSON.stringify(data.accounts[0].accountId));
			  $window.localStorage.setItem('currentAccountOwner', JSON.stringify(data.accounts[0].accountOwnerId));
			  $window.localStorage.setItem('loggedInUser', JSON.stringify(data.userId));
